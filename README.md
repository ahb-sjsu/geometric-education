...
> posited. No education-domain instrument has been evaluated by the series' admission filter
> ([xbse](https://github.com/ahb-sjsu/xbse)), and none currently passes its gate. Claims here
> should be read as theory at licensed strength, not validated measurement.
...
| **Geometric Education: Learning, Assessment, and the Topology of Understanding** | **Draft** |
